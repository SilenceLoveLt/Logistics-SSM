...
<body>
<input type="hidden" id="orderPageList" value="<%=basePath%>orderManageList/selectCancelByPage" />
<input type="hidden" id="cancelOrderList" value="<%=basePath%>orderManageList/cancleOrderList" />
...
<script type="text/javascript">
   ...
   /**重置查询条件*/
	...
	function oemp_editsr(orderId){
		var createUrl = $("#cancelOrderList").val();
