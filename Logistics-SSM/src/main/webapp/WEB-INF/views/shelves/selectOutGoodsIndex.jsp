...
<body>
<input type="hidden" id="selectOutGoodsList" value="<%=basePath%>goodsShelvesManageList/selectOutGoodsList" />
<input type="hidden" id="deleteOutGoodsShelves" value="<%=basePath%>goodsShelvesManageList/deleteOutGoodsShelves" />
...
var remark=null;
   ...
   var urlStr = $("#selectOutGoodsList").val();
   ...
   /* 删除  */
	 ...
	 var delUrl = $("#deleteOutGoodsShelves").val();
