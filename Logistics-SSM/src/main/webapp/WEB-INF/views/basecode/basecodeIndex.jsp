...
<link rel="stylesheet"
	href="<%=basePath%>static/bootstrap/bootstrap-table/bootstrap-table.css">
<link
	href="https://cdn.bootcss.com/bootstrap-validator/0.5.3/css/bootstrapValidator.css"
	rel="stylesheet">
<link rel="stylesheet"
	href="<%=basePath%>static/bootstrap/bootstrapValidator/css/bootstrapValidator.min.css">
<link rel="stylesheet"
	href="<%=basePath%>static/bootstrap/jquery-confirm/css/jquery-confirm.css">
<script src="<%=basePath%>static/My97DatePicker/WdatePicker.js"></script>
<script src="<%=basePath%>static/bootstrap/js/bootstrap.js"></script>
<script
	src="<%=basePath%>static/bootstrap/bootstrap-table/bootstrap-table.js"></script>
<script
	src="<%=basePath%>static/bootstrap/bootstrapValidator/js/bootstrapValidator.min.js"></script>
<script
	src="<%=basePath%>static/bootstrap/bootstrapValidator/js/bootstrap-table-zh-CN.js"></script>
<script
	src="<%=basePath%>static/bootstrap/jquery-confirm/js/jquery-confirm.js"></script>
...
<body>
	<input type="hidden" id="baseCodeTypePageList"
		value="<%=basePath%>basecodeManageList/selectCodeTypeListByPage" />
	<input type="hidden" id="baseCodePageList"
		value="<%=basePath%>basecodeManageList/selectCodeListByPage" />
	<input type="hidden" id="insertCodeType"
		value="<%=basePath%>basecodeManageList/insertCodeType" />
	<input type="hidden" id="updateCodeType"
		value="<%=basePath%>basecodeManageList/updateCodeType" />
	<input type="hidden" id="deleteInfoCodeType"
		value="<%=basePath%>basecodeManageList/deleteInfoCodeType" />
	<input type="hidden" id="deleteCodeTypeList"
		value="<%=basePath%>basecodeManageList/deleteListCodeType" />
	<input type="hidden" id="insertCode"
		value="<%=basePath%>basecodeManageList/insertCode" />
	<input type="hidden" id="updateCode"
		value="<%=basePath%>basecodeManageList/updateCode" />
	<input type="hidden" id="deleteInfoCode"
		value="<%=basePath%>basecodeManageList/deleteInfoCode" />
	<input type="hidden" id="deleteCodeList"
		value="<%=basePath%>basecodeManageList/deleteListCode" />
	...
	<div class="panel-body" style="padding-bottom: 0px;">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="container-fluid">
					<form id="searchBasecodeForm" name="searchBasecodeForm"
							...
							<div class="row">
								...
								<div class="col-md-2">
									<input type="text" class="form-control  input-sm "
										name="search_codeType" id="search_codeType"
										placeholder="请输入类别代码" oninput="checkInput()">
								</div>

								<label class="control-label col-md-1 ">类别名称:</label>
								<div class="col-md-2 ">
									<input type="text" class="form-control  input-sm "
										oninput="checkInput()" name="search_codeName"
										id="search_codeName" placeholder="请输入类别名称">
								</div>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog modal-lg" role="document">
			<form class="form-horizontal" role="form" id="baseCodeTypeForm"
				name="baseCodeTypeForm" method="post">
						...
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="codeType"
									id="codeType" oninput="check()" onmouseleave="checkInputing()"
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="codeName"
									id="codeName" oninput="check()" onmouseleave="checkInputing()"
									onkeyup="this.value=this.value.replace(/\s+/g,'')"
									placeholder="请输入..." />
							</div>
						</div>
						...
						<div class="form-group form-group-sm" style="padding-left: 10px">
							<div class="col-sm-12 ">
								<textarea class="form-control" name="remark" id="remark"
									style="resize: none; height: 70px" rows="3"
									placeholder="请输入..." oninput="check()"
									onmouseleave="checkInputing()"
									onkeyup="this.value=this.value.replace(/\s+/g,'')"></textarea>
							</div>
						</div>
					</div>
					<div class="form-group form-group-sm">
						<button id="okCodeType"
							class="btn btn-default  col-sm-1 col-sm-offset-2  "
							onclick="submitCodeType()" style="width: 80px">保存</button>
						<button id="resetedCodeType"
							class="btn btn-default  col-sm-1  col-sm-offset-2 "
							onclick="resetCodeType()" style="width: 80px">重置</button>
						<button id="closeCodeTypeModel" type="button"
							class="btn btn-default col-sm-1  col-sm-offset-2 "
	...
	<div class="modal fade" id="myModalTwo" tabindex="-1" role="dialog"
		aria-labelledby="gridSystemModalLabelTwo">
		<div class="modal-dialog modal-lg" role="document">
			<form class="form-horizontal" role="form" id="baseCodeForm"
				name="baseCodeForm" method="post">
				<div class="modal-content">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-label="Close">
						...
						<h4 class="modal-title" id="gridSystemModalLabelTwo">Modal
							title</h4>
					</div>
					<div class="modal-body" style="margin-right: 30px">
						...
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="code" id="code"
									oninput="check2()" onmouseleave="checkInputing2()"
									onkeyup="this.value=this.value.replace(/\s+/g,'')"
									placeholder="请输入..." />
							</div>
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="dataName"
									id="dataName" oninput="check2()"
									onmouseleave="checkInputing2()"
									onkeyup="this.value=this.value.replace(/\s+/g,'')"
									placeholder="请输入..." />
							</div>
						</div>
						...
						<div class="form-group form-group-sm" style="padding-left: 10px">
							<div class="col-sm-12 ">
								<textarea class="form-control" name="remark" id="remarkTwo"
									style="resize: none; height: 70px" rows="3"
									placeholder="请输入..." oninput="check2()"
									onmouseleave="checkInputing2()"
									onkeyup="this.value=this.value.replace(/\s+/g,'')"></textarea>
							</div>
						</div>
					...
					<div class="form-group form-group-sm">
						<button id="okCode"
							class="btn btn-default  col-sm-1 col-sm-offset-2  "
							onclick="submitCode()" style="width: 80px">保存</button>
						<button id="resetedCode"
							class="btn btn-default  col-sm-1  col-sm-offset-2 "
							onclick="resetCode()" style="width: 80px">重置</button>
						<button id="closeCodeModel" type="button"
							class="btn btn-default col-sm-1  col-sm-offset-2 "
							data-dismiss="modal">关闭</button>
					</div>
				</div>
	...
	<div id='table-div1' style="width: 45%; float: left;">
		<div class="btn-group" style="margin-top: 10px;">
			<button type="button" class="btn btn-default"
				onclick="addCodeTypeFun()" style="margin-left: 16px">
				<i class="fa fa-plus-square-o fa-lg"></i>&nbsp;新&nbsp;&nbsp;&nbsp;&nbsp;增
			</button>
			<button class="btn btn-default" onclick="deleteCodeTypeListFun()">
				<i class="fa fa-trash-o fa-lg"></i>&nbsp;批量删除
			</button>
		</div>
		<table
			class="display table table-striped table-bordered table-hover table-checkable text-center"
			id="codeTypeListTable" style="white-space: nowrap">
			<thead>
				<tr class="text-c">
					<th><input type="checkbox" id="checkCodeTypeall"
						class="checkCodeTypeall" name="checkBoxs" /></th>
					<th></th>
					<th>类别代码</th>
					<th>类别名称</th>
					<th>操作</th>
	...
	<div id='table-div2'
		style="width: 54%; float: right; visibility: hidden">
		<div class="btn-group" style="margin-top: 10px;">
			<button type="button" class="btn btn-default" onclick="addCodeFun()"
				style="margin-left: 16px">
				<i class="fa fa-plus-square-o fa-lg"></i>&nbsp;新&nbsp;&nbsp;&nbsp;&nbsp;增
			</button>
			<button class="btn btn-default" onclick="deleteCodeListFun()">
				<i class="fa fa-trash-o fa-lg"></i>&nbsp;批量删除
			</button>
		</div>
		<table
			class="display table table-striped table-bordered table-hover table-checkable text-center"
			id="codeListTable" style="white-space: nowrap">
			<thead>
				<tr class="text-c">
					<th><input type="checkbox" id="checkCodeall"
						class="checkCodeall" name="checkBoxsTwo" /></th>
					<th></th>
					<th>代码</th>
					<th>名称</th>
					<th></th>
...
<script type="text/javascript">
	...
	$("#okCodeType").attr("style", "background-color:grey;border-color:grey;color:white");
	$("#okCode").attr("disabled", "true");
	$("#okCode").attr("style", "background-color:grey;border-color:grey;color:white");
	function check() {
		$("#okCodeType").removeAttr("disabled");
		$("#resetedCodeType").removeAttr("disabled");
		$("#resetedCodeType").removeAttr("style",
				"border-color:grey;background-color:grey;color:white");
	...
	function checkInputing() {
		...
		if ((codeType == '') && (codeName == '') && (remark == '')) {
			...
			$("#okCodeType").attr("style",
					"background-color:grey;border-color:grey;color:white");
			$("#resetedCodeType").attr("style",
					"background-color:grey;border-color:grey;color:white");
		} else {
			check();
		}
	...
	function checkInputing2() {
		...
		if ((code == '') && (dataName == '') && (enable == '') && (sort == '')
				&& (remarkTwo == '')) {
			$("#okCode").attr("disabled", "true");
			$("#resetedCode").attr("disabled", "true");
			$("#okCode").attr("style",
					"background-color:grey;border-color:grey;color:white");
			$("#resetedCode").attr("style",
					"background-color:grey;border-color:grey;color:white");
		} else {
			check2();
		}
				...
				.dataTable(
						{
							...
							fnDrawCallback : function() {
								$(this).find('thead input[type=checkbox]')
										.removeAttr('checked');
							},
							aoColumnDefs : [ {
								'targets' : 0,
								...
								'render' : function(data, type, row) {
									return '<input class="checkbox_select" type="checkbox" data-status="'
											+ row.status
											+ '"name="id[]" value="'
											+ $('<div/>').text(row.codeType)
													.html() + '">';
							...
							aoColumns : [//列表元素  支持多种属性 
									...
									},
									{
										...
										render : function(data, type, row, meta) {
											var html = "<button type='button' class='btn btn-primary btn-sm oemp-privbtn' onclick=\"selectCodeTypeFun('"
													+ meta.row
													+ "')\">查看</button>"
													+ "&nbsp;&nbsp;&nbsp;&nbsp;<button type='button' class='btn btn-primary btn-sm oemp-privbtn' onclick=\"updateCodeTypeFun('"
													+ meta.row
													+ "')\">修改</button>"
													+ "&nbsp;&nbsp;&nbsp;&nbsp;<button type='button' class='btn btn-primary btn-sm oemp-privbtn' onclick=\"deleteCodeTypeFun('"
													+ row.codeType
													+ "')\">删除</button>"
											return html;
										}
				...
				.dataTable(
						{
							...
							aoColumnDefs : [ {
								...
								'className' : 'dt-body-center',
								'render' : function(data, type, row) {
									return '<input class="checkbox_selectTwo" type="checkbox" data-status="'
											+ row.status
											+ '"name="id[]" value="'
											+ $('<div/>').text(row.code).html()
											+ '">';
							...
							aoColumns : [//列表元素  支持多种属性 
									...
									},
									{
										"mData" : null,
										render : function(data, type, row, meta) {
											var html = "<button type='button' class='btn btn-primary btn-sm oemp-privbtn' onclick=\"selectCodeFun('"
													+ meta.row
													+ "')\">查看</button>"
													+ "&nbsp;&nbsp;&nbsp;&nbsp;<button type='button' class='btn btn-primary btn-sm oemp-privbtn' onclick=\"updateCodeFun('"
													+ meta.row
													+ "')\">修改</button>"
													+ "&nbsp;&nbsp;&nbsp;&nbsp;<button type='button' class='btn btn-primary btn-sm oemp-privbtn' onclick=\"deleteCodeFun('"
													+ meta.row
													+ "')\">删除</button>"
											return html;
										}
	...
	function closeCodeModel() {
		...
		$("#resetedCode").attr("disabled", "true");
		$("#okCode").attr("disabled", "true");
		$("#resetedCode").attr("style","background-color:grey;border-color:grey;color:white");
		$("#okCode").attr("style", "background-color:grey;border-color:grey;color:white");
	}
	...
	function submitCodeType() {
		var bootstrapValidator = $("#baseCodeTypeForm").data(
				'bootstrapValidator');
		//获取表单验证结果
		...
		if (validateResult) {
			...
			$.post(createCodeTypeUrl, $("#baseCodeTypeForm").serialize(),
					function(data) {
							...
							$.alert({
								...
								buttons : { //定义按钮
									confirm : {
										...
										btnClass : 'btn-primary',
										action : function() { //这里写点击按钮回调函数
											$("#baseCodeTypeForm").data(
													'bootstrapValidator')
													.resetForm();
											$('#baseCodeTypeForm')[0].reset();
											codeTypeRefresh(); //刷新列表
											$('#myModal').modal('hide');
											$('#okCodeType').removeAttr(
													"disabled");
										}
									}
								}
